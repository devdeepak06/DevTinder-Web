    ...
    <>
      <div className="navbar bg-base-300">
        ...
        <div className="flex-none gap-2">
          {user && (
            <div className="dropdown dropdown-end px-5 flex items-center">
              <p className="px-2">Welcome, {user.firstName}</p>
              <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
                <div className="w-10 rounded-full">
                  <img
                    alt={user.firstName}
                    src={user.photoUrl || `https://res.cloudinary.com/dkm44qhtl/image/upload/v1738429885/dummy%20avatar/yqavpipqbac218lxmebp.jpg`} />
                </div>
              </div>
              <ul
                tabIndex={0}
